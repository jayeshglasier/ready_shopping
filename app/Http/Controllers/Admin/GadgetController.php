...
class GadgetController extends Controller
{
    ...
    public function index()
    {
        try
        {
            ...
            if($search)
            {   
                $data['datarecords'] = Products::orderBy('pod_id',$pageOrder)->where('pod_main_cat_id',15)->where('pod_pro_name','like','%'.$search.'%')->paginate($pages);
            }else{
                $data['datarecords'] = Products::join('tbl_categorys','tbl_products.pod_cat_id','=','tbl_categorys.cat_id')->leftjoin('tbl_sub_categorys','tbl_products.pod_sub_cat_id','=','tbl_sub_categorys.sub_id')->where('pod_main_cat_id',15)->where('pod_seller_id',0)->orderBy('pod_id',$pageOrder)->paginate($pages);
            }
            return view('admin.shop.gadget-mgmt.index',$data);
        } catch (\Exception $e) {
    ...
    {
        $data['categorys'] = Category::where('cat_main_id',15)->where('cat_name','<>','')->orderBy('cat_name','ASC')->get();
        ...
        return view('admin.shop.gadget-mgmt.create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.shop.gadget-mgmt.edit',$data);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.shop.gadget-mgmt.view',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        {  
            ...
            if($insertData)
            {
                Session::flash('success', 'Gadget details created!');
                return redirect()->intended('/gadget');
            }else{
                Session::flash('error', "Gadget details isn't created!");
                return redirect()->intended('/gadget');
            }
    ...
    public function update(Request $request)
    {
        ...
        {  
            ...
            if($infoUpdate)
            {
                Session::flash('success', 'Gadget details updated!');
                return redirect()->intended('/gadget');
            }else{
                Session::flash('error', "Gadget details isn't updated!");
    ...
    public function exportPdf()
    {
        ...
        $pdf = PDF::loadView('admin.shop.gadget-mgmt.pdf-file', $data);
