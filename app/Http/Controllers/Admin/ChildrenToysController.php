...
class ChildrenToysController extends Controller
{
    ...
    public function index()
    {
        try
        {
            ...
            if($search)
            {   
                $data['datarecords'] = Products::orderBy('pod_id',$pageOrder)->where('pod_main_cat_id',13)->where('pod_pro_name','like','%'.$search.'%')->paginate($pages);
            }else{
                $data['datarecords'] = Products::join('tbl_categorys','tbl_products.pod_cat_id','=','tbl_categorys.cat_id')->leftjoin('tbl_sub_categorys','tbl_products.pod_sub_cat_id','=','tbl_sub_categorys.sub_id')->where('pod_main_cat_id',13)->where('pod_seller_id',0)->orderBy('pod_id',$pageOrder)->paginate($pages);
            }
            return view('admin.shop.toys-mgmt.index',$data);
        } catch (\Exception $e) {
    ...
    {
        $data['categorys'] = Category::where('cat_main_id',13)->where('cat_name','<>','')->orderBy('cat_name','ASC')->get();
        $data['choosetype'] = ChooseType::select('coo_id','coo_name')->where('coo_name','<>','')->orderBy('coo_id','ASC')->get();
        return view('admin.shop.toys-mgmt.create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.shop.toys-mgmt.edit',$data);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.shop.toys-mgmt.view',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        {  
            ...
            if($insertData)
            {
                Session::flash('success', 'Toy details created!');
                return redirect()->intended('/children-toys');
            }else{
                Session::flash('error', "Toy details isn't created!");
                return redirect()->intended('/children-toys');
            }
    ...
    public function update(Request $request)
    {
        ...
        {  
            ...
            if($infoUpdate)
            {
                Session::flash('success', 'Toy details updated!');
                return redirect()->intended('/children-toys');
            }else{
                Session::flash('error', "Toy details isn't updated!");
    ...
    public function exportPdf()
    {
        ...
        $pdf = PDF::loadView('admin.shop.toys-mgmt.pdf-file', $data);
