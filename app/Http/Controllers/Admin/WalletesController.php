...
class WalletesController extends Controller
{
    ...
    public function index()
    {
        try
        {
            ...
            if($search)
            {   
                $data['datarecords'] = Products::orderBy('pod_id',$pageOrder)->where('pod_main_cat_id',11)->where('pod_pro_name','like','%'.$search.'%')->paginate($pages);
            }else{
                $data['datarecords'] = Products::join('tbl_categorys','tbl_products.pod_cat_id','=','tbl_categorys.cat_id')->leftjoin('tbl_sub_categorys','tbl_products.pod_sub_cat_id','=','tbl_sub_categorys.sub_id')->where('pod_main_cat_id',11)->where('pod_seller_id',0)->orderBy('pod_id',$pageOrder)->paginate($pages);
            }
            return view('admin.shop.wallets-mgmt.index',$data);
        } catch (\Exception $e) {
    ...
    {
        $data['categorys'] = Category::where('cat_main_id',11)->where('cat_name','<>','')->orderBy('cat_name','ASC')->get();
        ...
        return view('admin.shop.wallets-mgmt.create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.shop.wallets-mgmt.edit',$data);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.shop.wallets-mgmt.view',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        {  
            ...
            if($insertData)
            {
                Session::flash('success', 'Wallet details added!');
                return redirect()->intended('/walletes');
            }else{
                Session::flash('error', "Wallet details isn't added!");
                return redirect()->intended('/walletes');
            }
    ...
    public function update(Request $request)
    {
        ...
        {  
            ...
            if($infoUpdate)
            {
                Session::flash('success', 'Wallet details updated!');
                return redirect()->intended('/walletes');
            }else{
                Session::flash('error', "Wallet details isn't updated!");
    ...
    { 
        if(Products::where('pod_unique_id',$id)->exists())
        {
            ...
            Session::flash('success', 'Wallet details deleted!');
            return redirect()->intended('/walletes');
        }else{
          Session::flash('error', "Wallet details isn't deleted!");
          return redirect()->intended('/walletes');
        }
    }
    ...
    public function exportPdf()
    {
        ...
        $pdf = PDF::loadView('admin.shop.wallets-mgmt.pdf-file', $data);
