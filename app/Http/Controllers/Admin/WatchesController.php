...
class WatchesController extends Controller
{
    ...
    public function index()
    {
        try
        {
            ...
            if($search)
            {   
                $data['datarecords'] = Products::orderBy('pod_id',$pageOrder)->where('pod_main_cat_id',7)->where('pod_pro_name','like','%'.$search.'%')->paginate($pages);
            }else{
                $data['datarecords'] = Products::join('tbl_categorys','tbl_products.pod_cat_id','=','tbl_categorys.cat_id')->leftjoin('tbl_sub_categorys','tbl_products.pod_sub_cat_id','=','tbl_sub_categorys.sub_id')->where('pod_main_cat_id',7)->where('pod_seller_id',0)->orderBy('pod_id',$pageOrder)->paginate($pages);
            }
            return view('admin.shop.watches-mgmt.index',$data);
        } catch (\Exception $e) {
    ...
    {
        $data['categorys'] = Category::where('cat_main_id',7)->where('cat_name','<>','')->orderBy('cat_name','ASC')->get();
        ...
        return view('admin.shop.watches-mgmt.create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.shop.watches-mgmt.edit',$data);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.shop.watches-mgmt.view',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        {  
            ...
            if($insertData)
            {
                Session::flash('success', 'Watch details added!');
                return redirect()->intended('/watches');
            }else{
                Session::flash('error', "Watch details isn't added!");
                return redirect()->intended('/watches');
            }
    ...
    public function update(Request $request)
    {
        ...
        {  
            ...
            if($infoUpdate)
            {
                Session::flash('success', 'Watch details updated!');
                return redirect()->intended('/watches');
            }else{
                Session::flash('error', "Watch details isn't updated!");
    ...
    { 
        if(Products::where('pod_unique_id',$id)->exists())
        {
            ...
            Session::flash('success', 'Watch details deleted!');
            return redirect()->intended('/watches');
        }else{
          Session::flash('error', "Watch details isn't deleted!");
          return redirect()->intended('/watches');
        }
    }
    ...
    public function exportPdf()
    {
        ...
        $pdf = PDF::loadView('admin.shop.watches-mgmt.pdf-file', $data);
