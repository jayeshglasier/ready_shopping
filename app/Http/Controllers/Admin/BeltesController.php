...
class BeltesController extends Controller
{
    ...
    public function index()
    {
        try
        {
            ...
            if($search)
            {   
                $data['datarecords'] = Products::orderBy('pod_id',$pageOrder)->where('pod_main_cat_id',8)->where('pod_pro_name','like','%'.$search.'%')->paginate($pages);
            }else{
                $data['datarecords'] = Products::join('tbl_categorys','tbl_products.pod_cat_id','=','tbl_categorys.cat_id')->leftjoin('tbl_sub_categorys','tbl_products.pod_sub_cat_id','=','tbl_sub_categorys.sub_id')->where('pod_main_cat_id',8)->where('pod_seller_id',0)->orderBy('pod_id',$pageOrder)->paginate($pages);
            }
            return view('admin.shop.belts-mgmt.index',$data);
        } catch (\Exception $e) {
    ...
    {
        $data['categorys'] = Category::where('cat_main_id',8)->where('cat_name','<>','')->orderBy('cat_name','ASC')->get();
        ...
        return view('admin.shop.belts-mgmt.create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.shop.belts-mgmt.edit',$data);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.shop.belts-mgmt.view',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        {  
            if(Products::where('pod_pro_name',$request->pod_pro_name)->exists())
            {
                ...
                return redirect()->intended('/create-beltes');
            }
            ...
            if($insertData)
            {
                Session::flash('success', 'Belt detail added!');
                return redirect()->intended('/beltes');
            }else{
                Session::flash('error', "Belt detail isn't added!");
                return redirect()->intended('/beltes');
            }
    ...
    public function update(Request $request)
    {
        ...
        {  
            ...
            if($infoUpdate)
            {
                Session::flash('success', 'Belt detail updated!');
                return redirect()->intended('/beltes');
            }else{
                Session::flash('error', "Belt detail isn't updated!");
    ...
    public function exportPdf()
    {
        ...
        $pdf = PDF::loadView('admin.shop.belts-mgmt.pdf-file', $data);
