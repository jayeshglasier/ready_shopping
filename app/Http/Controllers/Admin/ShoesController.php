...
class ShoesController extends Controller
{
    ...
    public function index()
    {
        try
        {
            ...
            if($search)
            {   
                $data['datarecords'] = Products::orderBy('pod_id',$pageOrder)->where('pod_main_cat_id',9)->where('pod_pro_name','like','%'.$search.'%')->paginate($pages);
            }else{
                $data['datarecords'] = Products::join('tbl_categorys','tbl_products.pod_cat_id','=','tbl_categorys.cat_id')->leftjoin('tbl_sub_categorys','tbl_products.pod_sub_cat_id','=','tbl_sub_categorys.sub_id')->where('pod_main_cat_id',9)->where('pod_seller_id',0)->orderBy('pod_id',$pageOrder)->paginate($pages);
            }
            return view('admin.shop.shoes-mgmt.index',$data);
        } catch (\Exception $e) {
    ...
    {
        $data['categorys'] = Category::where('cat_main_id',9)->where('cat_name','<>','')->orderBy('cat_name','ASC')->get();
        ...
        return view('admin.shop.shoes-mgmt.create',$data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.shop.shoes-mgmt.edit',$data);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin.shop.shoes-mgmt.view',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        {  
            if(Products::where('pod_pro_name',$request->pod_pro_name)->exists())
            {
                ...
                return redirect()->intended('/create-shoes');
            }
            ...
            $insertData['pod_size'] = ($request->pod_size !="") ? implode(",",$request->pod_size) :'';
            ...
            $subData->pri_product_id = $insertData->pod_id;
            ...
            if($picture)
            {
                ...
                $subinsertData->pri_product_id = $insertData->pod_id;
            ...
            if($insertData)
            {
                Session::flash('success', 'Shoes details Added!');
                return redirect()->intended('/shoes');
            }else{
                Session::flash('error', "Shoes details isn't Added!");
                return redirect()->intended('/shoes');
            }
    ...
    public function update(Request $request)
    {
        ...
        {  
            ...
            $updateData['pod_size'] = ($request->pod_size !="") ? implode(",",$request->pod_size) :'';
            ...
            if($infoUpdate)
            {
                Session::flash('success', 'Shoes details updated!');
                return redirect()->intended('/shoes');
            }else{
                Session::flash('error', "Shoes details isn't updated!");
    ...
    { 
        if(Products::where('pod_unique_id',$id)->exists())
        {
            ...
            Session::flash('success', 'Shoes details deleted!');
            return redirect()->intended('/shoes');
        }else{
          Session::flash('error', "Shoes details isn't deleted!");
          return redirect()->intended('/shoes');
        }
    }
    ...
    public function exportPdf()
    {
        ...
        $pdf = PDF::loadView('admin.shop.shoes-mgmt.pdf-file', $data);
