...
<head>
  ...
  <title>Add Delivery Boy - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Delivery Boy Registration Form</h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('delivery-boys') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Delivery Boys List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('store-delivery-boys') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Delivery Boy Name<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="use_full_name" id="use_full_name" placeholder="Delivery Boy Name" value="{{ old('use_full_name') }}" required maxlength="200" autofocus>
                      ...
                      <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Save</button> <a href="{{ url('delivery-boys') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                    <!--------- End Form  --------->
