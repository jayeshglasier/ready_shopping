...
<head>
  ...
  <title>Update Delivery Boy - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Update Delivery Boy Detail</h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('delivery-boys') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Delivery Boy List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-delivery-boys') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <input type="hidden" class="form-control" name="use_unique_id" value="{{ $editData->use_unique_id }}">
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Delivery Boy Name<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="use_full_name" id="use_full_name" placeholder="Delivery Boy Name" value="{{ $editData->use_full_name }}" required maxlength="200" autofocus>
                        ...
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="use_shop_name" id="use_shop_name" placeholder="Shop Name" value="{{ $editData->use_shop_name }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-12 col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="use_shop_address" id="use_shop_address" placeholder="Shop Address" value="{{ $editData->use_shop_address }}" maxlength="250">
                      ...
                      <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('delivery-boys') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                    <!--------- End Form  --------->
