...
<head>
    ...
    <title>Delivery Boys Record - Ready Shopping</title>
    <!--------- Begin Css Style  --------->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="row right-15">
                                            <div class="col-12"> <a href="{{ url('create-delivery-boys') }}" class="btn btn-primary" data-toggle="tooltip" title="Add Delivery Boy!"><i class="fas fa-plus mr-2"></i>Add Delivery Boy</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" role="form" method="get" action="{{ url('/delivery-boys') }}">
                                            <div class="row">
                                                ...
                                                <tbody>@if(count($datarecords) > 0)
                                                    ...
                                                    <tr>@if($pageOrder == "ASC")
                                                        ...
                                                        <td class="text-center" width="15%">
                                                            <!--------- Begin Edit Link --------->
                                                            <a href="{{ url('edit-delivery-boys',$data->id) }}" class="btn btn-icon btn-primary mr-1" data-toggle="tooltip" title="Edit Delivery Boy!"><i class="far fa-edit"></i>
                                                            </a>
                                                            <!--------- End Edit Link --------->
                                                            <!--------- Begin Delete Link --------->
                                                            <a href="{{ url('delete-delivery-boys',$data->id) }}" onclick="return confirm('Are you sure you want to delete this record?')" data-toggle="tooltip" title="Delete Delivery Boy!">
 ...
 $('input[name=toggle]').change(function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        if(data.status == "true")
        {
          alert("Delivery Boy active successfully.");
        }
        else if(data.status == "false")
        {
          alert("Delivery Boy inactive successfully.");
        }
      }
    });
    }); 
