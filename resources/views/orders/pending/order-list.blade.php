                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Pending Products Order List</h4>
                                            ...
                                            <table class="table table-striped" id="table-1">
                                                ...
                                                <tbody>@if(count($datarecords) > 0)
                                                    ...
                                                    <tr>@if($pageOrder == "ASC")
                                                        ...
                                                        <td>{{ $data->ord_qty_ordered }} -/</td>
                                                        <td>{{ $data->ord_unit_per_price }}</td>
                                                        <td>{{ $data->ord_grand_total }}</td>
                                                        ...
                                                        <td class="text-center" width="15%">
                                                            ...
                                                            <!--------- End Edit Link --------->
                                                             <!--------- Begin View Link --------->
                                                            <a href="#" class="btn btn-icon btn-success mr-1" data-toggle="tooltip" title="View Product!"><i class="far fa-eye"></i>
                                                            </a>
                                                            <!--------- End Edit Link --------->
                                                            <!--------- Begin Delete Link --------->
