                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('orders-list') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Category List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-assign-order') }}" enctype="multipart/form-data">
                      ...
                      <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('orders-list') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                    <!--------- End Form  --------->
