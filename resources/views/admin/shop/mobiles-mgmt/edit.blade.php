...
<head>
  ...
  <title>Update Mobile - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Update Mobile <small>(Mobile can be managed from here)</small></h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('/mobiles') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Mobile List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-mobiles') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Mobile Title<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Mobile Title" value="{{ $editData->pod_pro_name }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            <label>Mobile Discription<span class="require-star">*</span></label>
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here mobile description...">{{ $editData->pod_pro_description }}</textarea>
                       ...
                       <div class="row">
                          <div class="col-12 col-md-3">
                           ...
                           <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>Colour</label>
                              <?php $prod_color = explode(',',$editData->pod_colour); ?>
							   <select name="pod_colour[]" id="pod_colour" class="pod_colour form-control  select2" multiple="multiple">
                                    ...
                                    @foreach ($colors as $colors_list)
                                      <option value="{{ $colors_list->col_name }}" @if(in_array($colors_list->col_name,$prod_color)) selected="true" @endif>{{ $colors_list->col_name }}</option>
                                    @endforeach
                                </select>
                          ...
                          <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>Screen Size</label>
                               <input type="text" class="form-control" name="pod_size" id="pod_size" placeholder="Ex: 16.55 cm (6.51 inch) HD+ display with 720 x 1600 pixels resolution" value="{{ $editData->pod_size }}" maxlength="40">
                      ...
                      <a href="{{ asset('public/assets/img/products/'.$editData->pod_picture) }}" target="_blank">Mobile Picture</a>
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('/mobiles') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
