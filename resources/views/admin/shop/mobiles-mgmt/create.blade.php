...
<head>
  ...
  <title>Add New Mobile - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Add Mobile <small>(Mobile can be managed from here)</small></h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('/mobiles') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Mobiles List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('store-mobiles') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <span class="require-star">* Required</span>
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Mobile Name<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Mobile Name" value="{{ old('pod_pro_name') }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here mobile description..."></textarea>
                         ...
                         <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="pod_return_policy" id="pod_return_policy" placeholder="Ex :  30 Day Free Returns & Exchange "></textarea>
                             @if($errors->has('pod_return_policy')) 
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pod_size" id="pod_size" placeholder="Ex: 16.55 cm (6.51 inch) HD+ display with 720 x 1600 pixels resolution" value="{{ old('pod_size') }}" maxlength="40">
                       ...
                       <div class="row">
                         <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Mobile Picture<span class="require-star">*</span></label>
                       ...
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Save</button> <a href="{{ url('/mobiles') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
