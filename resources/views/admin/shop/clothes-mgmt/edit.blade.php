...
<head>
  ...
  <title>Update Cloth - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Update Cloth <small>(Cloth can be managed from here)</small></h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('/clothes') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Clothes List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-clothes') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Cloth Title<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Cloth Title" value="{{ $editData->pod_pro_name }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            <label>Cloth Discription<span class="require-star">*</span></label>
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here Cloth description...">{{ $editData->pod_pro_description }}</textarea>
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>Size</label>
                            <select name="pod_size[]" id="pod_size" class="pod_size form-control  select2" multiple="multiple">
                            <?php
                                    $prod_size = explode(",",$editData->pod_size);                                    
                                 ?>
                              <option value="">Select Size</option>
                                <option value="S" @if(in_array("S",$prod_size)) selected="true" @endif>S</option>
                                <option value="M"  @if(in_array('M',$prod_size)) selected="selected" @endif>M</option>
                                <option value="L" @if(in_array('L',$prod_size))  selected="selected" @endif>L</option>
                                <option value="XL" @if(in_array('XL',$prod_size)) selected="selected" @endif>XL</option>
                                <option value="2XL" @if(in_array('2XL',$prod_size)) selected="selected" @endif>2XL</option>
                              </select>
                      ...
                      <a href="{{ asset('public/assets/img/products/'.$editData->pod_picture) }}" target="_blank">Cloth Picture</a>
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('/clothes') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
