...
<head>
  ...
  <title>Update Watch - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Update Watch <small>(Watch can be managed from here)</small></h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('/watches') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Watch List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-watches') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Watch Title<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Watch Title" value="{{ $editData->pod_pro_name }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here watch description...">{{ $editData->pod_pro_description }}</textarea>
                            ...
                            <?php $prod_colour = explode(",",$editData->pod_colour); //print_r($prod_colour);exit;?>
                                <select name="pod_colour[]" id="pod_colour" class="pod_colour form-control  select2" multiple="multiple">
                                    ...
                                    @foreach ($colors as $colors_list)
                                      <option value="{{ $colors_list->col_name }}" @if(in_array($colors_list->col_name,$prod_colour)) selected="true" @endif>{{ $colors_list->col_name }}</option>
                                    @endforeach
                                </select>
                      ...
                      <a href="{{ asset('public/assets/img/products/'.$editData->pod_picture) }}" target="_blank">Watch Picture</a>
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('/watches') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
