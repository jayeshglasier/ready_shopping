...
<head>
  ...
  <title>Update Gadget - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Update Gadget <small>(Gadget can be managed from here)</small></h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('/gadget') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Gadgets List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-gadget') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Gadget Title<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Gadget Title" value="{{ $editData->pod_pro_name }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            <label>Gadget Discription<span class="require-star">*</span></label>
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here gadget description...">{{ $editData->pod_pro_description }}</textarea>
                      ...
                      <a href="{{ asset('public/assets/img/products/'.$editData->pod_picture) }}" target="_blank">Gadget Picture</a>
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('/gadget') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
