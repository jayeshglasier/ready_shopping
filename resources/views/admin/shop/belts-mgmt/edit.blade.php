              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-beltes') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here Belt description..." required>{{ $editData->pod_pro_description }}</textarea>
                      ...
                      <a href="{{ asset('public/assets/img/products/'.$editData->pod_picture) }}" target="_blank">Product Picture</a>
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('/beltes') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
