...
<head>
    ...
    <title>Beltes Products Record - Ready Shopping</title>
    <!--------- Begin Css Style  --------->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Belts Products</h4>
                                        <div class="row right-15">
                                            <div class="col-12"> <a href="{{ url('create-beltes') }}" class="btn btn-primary" data-toggle="tooltip" title="Add Product!"><i class="fas fa-plus mr-2"></i>Add Belt</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" role="form" method="get" action="{{ url('/beltes') }}">
                                            <div class="row">
                                                ...
                                                <tbody>@if(count($datarecords) > 0)
                                                    ...
                                                    <tr>@if($pageOrder == "ASC")
                                                        ...
                                                        <td class="text-center" width="15%">
                                                            <!--------- Begin Edit Link --------->
                                                            <a href="{{ url('edit-beltes',$data->pod_unique_id) }}" class="btn btn-icon btn-primary mr-1" data-toggle="tooltip" title="Edit Product!"><i class="far fa-edit"></i>
                                                            </a>
                                                            <!--------- End Edit Link --------->
                                                             <!--------- Begin View Link --------->
                                                            <a href="{{ url('view-beltes',$data->pod_unique_id) }}" class="btn btn-icon btn-success mr-1" data-toggle="tooltip" title="View Product!"><i class="far fa-eye"></i>
                                                            </a>
                                                            <!--------- End Edit Link --------->
                                                            <!--------- Begin Delete Link --------->
                                                            <a href="{{ url('delete-beltes',$data->pod_unique_id) }}" onclick="return confirm('Are you sure you want to delete this record?')" data-toggle="tooltip" title="Delete Product!">
