...
<head>
  ...
  <title>Add New Girl Beauty - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Add Girl Beauty <small>(Girl Beauty can be managed from here)</small></h4>
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('/girl-beauty') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Girls Beauty List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('store-girl-beauty') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <span class="require-star">* Required</span>
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Girl Beauty Name<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Girl Beauty Name" value="{{ old('pod_pro_name') }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            <label>Girl Beauty Discription<span class="require-star">*</span></label>
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here girl beauty description..."></textarea>
                      ...
                      <div class="row">
                        <div class="col-12 col-md-3">
                         ...
                         <div class="col-12 col-md-3" style="display: none;">
                          <div class="form-group">
                            <label>Colour</label>
                            <input type="text" class="form-control" name="pod_colour" id="pod_colour" placeholder="Colour" value="" maxlength="20">
                        ...
                        <div class="col-12 col-md-3" style="display: none;">
                          <div class="form-group">
                            <label>Size</label>
                            <input type="text" class="form-control" name="pod_size" id="pod_size" placeholder="Size" value="" maxlength="20">
                       ...
                       <div class="row">
                         <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Girl Beauty Picture<span class="require-star">*</span></label>
                       ...
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Save</button> <a href="{{ url('/girl-beauty') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
