...
<head>
  ...
  <title>Add New Wallet - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Add Wallet <small>(Wallet can be managed from here)</small></h4>
                  ...
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('store-walletes') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      <span class="require-star">* Required</span>
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Wallet Name<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Wallet Name" value="{{ old('pod_pro_name') }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here wallet description..."></textarea>
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                         <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Wallet Picture<span class="require-star">*</span></label>
                       ...
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Save</button> <a href="{{ url('/walletes') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
