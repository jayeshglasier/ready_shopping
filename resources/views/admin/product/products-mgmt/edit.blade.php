                      ...
                      <div class="row">
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            ...
                            <select class="form-control selectric" name="pod_main_cat_id" id="pod_main_cat_id" required onchange="showDiv('productWeight', this)">
                        ...
                        @if($editData->pod_main_cat_id == 3)
                         <div class="col-12 col-md-3" id="productWeight">
                          <div class="form-group">
                            <label>Weight</label>
                            <input type="text" class="form-control  pod_weight" name="pod_weight" id="pod_weight" placeholder="1kg" value="{{ $editData->pod_weight }}" maxlength="20">
                            @if($errors->has('pod_weight')) <span class="help-block">
                                <strong>{{ $errors->first('pod_weight') }}</strong>
                                </span> 
                            @endif
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here product description...">{{ $editData->pod_pro_description }}</textarea>
                       ...
                       <div class="row">
                        <div class="col-12 col-md-3">
                         ...
                         <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>Colour</label>
                            <input type="text" class="form-control" name="pod_colour" id="pod_colour" placeholder="Colour" value="{{ $editData->pod_colour }}" maxlength="20">
                        ...
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>Size</label>
                            <input type="text" class="form-control" name="pod_size" id="pod_size" placeholder="Size" value="{{ $editData->pod_size }}" required maxlength="40">
