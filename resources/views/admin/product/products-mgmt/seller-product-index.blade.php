...
<head>
    ...
    <title>Seller Products Record - Ready Shopping</title>
    <!--------- Begin Css Style  --------->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" role="form" method="get" action="{{ url('/seller-products') }}">
                                            <div class="row">
                                               ...
                                               <div class="col-12 col-md-2 filter-forms" style="padding-right: 0px;padding-left: 10px;">
                                                    <div class="form-group">
                                                        <select class="form-control selectric" name="category">
                                                             ...
                                                             @foreach($sellerRecord as $category)
                                                              <option value="{{ $category->id }}" @if($categoryId == $category->id) selected="true" @endif>{{ $category->use_full_name}} ({{ $category->use_village_name}})</option>
                                                              @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <tbody>@if(count($datarecords) > 0)
                                                    ...
                                                    <tr>@if($pageOrder == "ASC")
                                                        ...
                                                        <td class="text-center" width="15%">
                                                            <!--------- Begin Edit Link --------->
                                                            <a href="{{ url('/seller/edit-products',$data->pod_unique_id) }}" class="btn btn-icon btn-primary mr-1" data-toggle="tooltip" title="Edit Product!"><i class="far fa-edit"></i>
                                                            </a>
                                                            <!--------- End Edit Link --------->
                                                             <!--------- Begin View Link --------->
                                                            <a href="{{ url('/seller/view-products',$data->pod_unique_id) }}" class="btn btn-icon btn-success mr-1" data-toggle="tooltip" title="View Product!"><i class="far fa-eye"></i>
                                                            </a>
                                                            <!--------- End Edit Link --------->
                                                            <!--------- Begin Delete Link --------->
                                                            <a href="{{ url('/seller/delete-products',$data->pod_unique_id) }}" onclick="return confirm('Are you sure you want to delete this record?')" data-toggle="tooltip" title="Delete Product!">
