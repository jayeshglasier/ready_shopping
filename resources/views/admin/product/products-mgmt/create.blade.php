                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('store-products') }}" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                         ...
                         <div class="col-12 col-md-3" id="productWeight" style="display: none;">
                          <div class="form-group">
                            <label>Weight</label>
                            <input type="text" class="form-control  pod_weight" name="pod_weight" id="pod_weight" placeholder="1kg" value="{{ old('pod_weight') }}" maxlength="20">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here product description..."></textarea>
                       ...
                       <div class="row">
                        <div class="col-12 col-md-3">
                         ...
                         <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>Colour</label>
                            <input type="text" class="form-control" name="pod_colour" id="pod_colour" placeholder="Colour" value="{{ old('pod_colour') }}" maxlength="20">
                        ...
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>Size</label>
                            <input type="text" class="form-control" name="pod_size" id="pod_size" placeholder="Size" value="{{ old('pod_size') }}" maxlength="40">
