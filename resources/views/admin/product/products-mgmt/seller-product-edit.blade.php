...
<head>
  ...
  <title>Update Seller Product - Ready Shopping</title>
  <!--------- Begin Css Style --------->
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="row right-15">
                      <div class="col-12"> <a href="{{ url('seller-products') }}" class="btn btn-primary"><i class="fas fa-list mr-2"></i>Product List</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('seller/update-products') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <a href="{{ asset('public/assets/img/products/'.$editData->pod_picture) }}" target="_blank">Product Picture</a>
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('seller-products') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
