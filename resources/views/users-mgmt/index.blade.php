...
<head>
    ...
    <title>Users Record - Ready Shopping</title>
    <!--------- Begin Css Style  --------->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="row right-15">
                                            <div class="col-12"> <a href="{{ url('create-users') }}" class="btn btn-primary" data-toggle="tooltip" title="Add User!"><i class="fas fa-plus mr-2"></i>Add User</a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-striped" id="table-1">
                                                ...
                                                <tbody>@if(count($datarecords) > 0)
                                                    ...
                                                    <tr>@if($pageOrder == "ASC")
                                                        ...
                                                        <td>{{ $data->use_alt_mobile_number }}</td>
                                                        <td>
                                                        ...
                                                        <td class="text-center" width="15%">
                                                            <!--------- Begin Edit Link --------->
                                                            <a href="{{ url('edit-users',$data->remember_token) }}" class="btn btn-icon btn-primary mr-1" data-toggle="tooltip" title="Edit User!"><i class="far fa-edit"></i>
                                                            </a>
                                                            <!--------- End Edit Link --------->
                                                            <!--------- Begin Delete Link --------->
                                                            <a href="{{ url('delete-users',$data->use_unique_id) }}" onclick="return confirm('Are you sure you want to delete this record?')" data-toggle="tooltip" title="Delete User!">
                                                    ...
                                                    @endforeach 
                                                    @else
                                                    <td colspan="10" style="text-align: center;">Record not available!</td>
                                                    @endif
                                                </tbody>
                                            </table>
